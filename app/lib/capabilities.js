...
export const videoModels = [
  ...
  // Runway
  { id: "runway_gen_45", label: "Runway Gen 4.5", family: "Runway", icon: "run_circle", color: "#10b981", desc: "World's #1 ranked video model for prompt adherence.", genTime: 90, fal_model: "runway/gen4.5", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "10 seconds"] } },
  // Luma
