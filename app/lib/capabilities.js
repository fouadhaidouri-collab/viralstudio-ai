...
export const videoModels = [
  ...
  // Grok (xAI)
  { id: "grok_imagine_video", label: "Grok Imagine Video", family: "Grok", icon: "psychology", color: "#06b6d4", desc: "xAI's creative video generation with rich imagination and audio.", genTime: 90, fal_model: "xai/grok-imagine-video/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["4 seconds", "6 seconds", "8 seconds"] } },
  { id: "grok_imagine_video_15", label: "Grok Imagine Video 1.5", family: "Grok", icon: "psychology", color: "#22d3ee", desc: "Next-gen xAI video with enhanced motion and lip-sync.", genTime: 120, fal_model: "xai/grok-imagine-video/v1.5/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "10 seconds"] } },
  // Seedance (ByteDance)
