...
export const videoModels = [
  // Veo (Google)
  { id: "veo_31", label: "Veo 3.1", family: "Veo", icon: "videocam", color: "#4285F4", desc: "Google's flagship video model with 4K support and scene extension.", genTime: 120, fal_model: "fal-ai/veo3.1/image-to-video", options: { aspect_ratio: ["9:16", "16:9"], resolution: ["720p", "1080p", "4k"], duration: ["4 seconds", "6 seconds", "8 seconds"] } },
  { id: "veo_31_fast", label: "Veo 3.1 Fast", family: "Veo", icon: "videocam", color: "#7c3aed", desc: "Google's fastest video model with stunning quality.", genTime: 60, fal_model: "fal-ai/veo3.1/fast/image-to-video", options: { aspect_ratio: ["9:16", "16:9"], resolution: ["720p", "1080p", "4k"], duration: ["4 seconds", "6 seconds", "8 seconds"] } },
  { id: "veo_31_lite", label: "Veo 3.1 Lite", family: "Veo", icon: "videocam", color: "#a78bfa", desc: "Google's accessible tier for high-volume rapid iteration.", genTime: 45, fal_model: "fal-ai/veo3.1/lite/image-to-video", options: { aspect_ratio: ["9:16", "16:9"], resolution: ["720p", "1080p"], duration: ["4 seconds", "6 seconds", "8 seconds"] } },
  // Grok (xAI)
  { id: "grok_imagine_video", label: "Grok Imagine Video", family: "Grok", icon: "psychology", color: "#06b6d4", desc: "xAI's creative video generation with rich imagination and audio.", genTime: 90, fal_model: "xai/grok-imagine-video/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "8 seconds", "10 seconds", "15 seconds"] } },
  { id: "grok_imagine_video_15", label: "Grok Imagine Video 1.5", family: "Grok", icon: "psychology", color: "#22d3ee", desc: "Next-gen xAI video with enhanced motion and lip-sync.", genTime: 120, fal_model: "xai/grok-imagine-video/v1.5/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "8 seconds", "10 seconds", "15 seconds"] } },
  // Seedance (ByteDance)
  { id: "seedance_15_pro", label: "Seedance 1.5 Pro", family: "Seedance", icon: "directions_run", color: "#f59e0b", desc: "ByteDance's reliable video generation with smooth motion.", genTime: 180, fal_model: "fal-ai/bytedance/seedance/v1.5/pro/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "10 seconds"] } },
  ...
  // Kling
  { id: "kling_21_std", label: "Kling 2.1 Standard", family: "Kling", icon: "smart_display", color: "#ef4444", desc: "Cost-efficient Kling with high-quality motion synthesis.", genTime: 150, fal_model: "fal-ai/kling-video/v2.1/standard/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "10 seconds"] } },
  { id: "kling_25_turbo_pro", label: "Kling 2.5 Turbo Pro", family: "Kling", icon: "smart_display", color: "#dc2626", desc: "Fastest Kling with cinematic visuals and fluid motion.", genTime: 90, fal_model: "fal-ai/kling-video/v2.5-turbo/pro/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "10 seconds"] } },
  { id: "kling_26_pro", label: "Kling 2.6 Pro", family: "Kling", icon: "smart_display", color: "#b91c1c", desc: "Top-tier Kling with native audio and cinematic motion.", genTime: 180, fal_model: "fal-ai/kling-video/v2.6/pro/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "10 seconds"] } },
  { id: "kling_30_std", label: "Kling 3.0 Standard", family: "Kling", icon: "smart_display", color: "#ef4444", desc: "Latest Kling with improved quality and native audio.", genTime: 200, fal_model: "fal-ai/kling-video/v3/standard/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "10 seconds"] } },
  { id: "kling_30_pro", label: "Kling 3.0 Pro", family: "Kling", icon: "smart_display", color: "#dc2626", desc: "Premium Kling with multi-shot support and best quality.", genTime: 240, fal_model: "fal-ai/kling-video/v3/pro/image-to-video", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "10 seconds", "15 seconds"] } },
  // Runway
  { id: "runway_gen_45", label: "Runway Gen 4.5", family: "Runway", icon: "run_circle", color: "#10b981", desc: "World's #1 ranked video model for prompt adherence.", genTime: 90, fal_model: "fal-ai/runway-gen3", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "10 seconds"] } },
  // Luma
  { id: "luma_ray_2", label: "Luma Ray 2", family: "Luma", icon: "flare", color: "#8b5cf6", desc: "Photorealistic video generation with dream-like quality.", genTime: 120, fal_model: "fal-ai/luma-dream-machine/ray-2", options: { aspect_ratio: ["9:16", "16:9", "1:1"], resolution: ["720p", "1080p"], duration: ["5 seconds", "9 seconds"] } },
  // Pika
  { id: "pika_21", label: "Pika 2.1", family: "Pika", icon: "pets", color: "#ec4899", desc: "Versatile video creation with widest aspect ratio support.", genTime: 60, fal_model: "fal-ai/pika/v2.1/image-to-video", options: { aspect_ratio: ["16:9", "9:16", "1:1", "4:5", "5:4", "3:2", "2:3"], resolution: ["720p", "1080p"], duration: ["5 seconds"] } },
  // Hailuo (MiniMax)
